...
public class NpcHomeResident : MonoBehaviour
{
    ...
    void BeginReturnHome()
    {
        returningHome = true;
        PauseAi();
        NpcRoleUtility.SetAction(gameObject, "V? nhà cu trú");
    }

    void MoveHome()
    {
        NpcRoleUtility.MoveTowards(gameObject, homePoint.position, fallbackMoveSpeed);
        NpcRoleUtility.SetAction(gameObject, "Ðang v? nhà");
    ...
    void HideAtHome()
    {
        ...
        SetVisible(false);
        SetColliders(false);
        NpcRoleUtility.SetAction(gameObject, "Ðã vào nhà");
    }
    ...
    void ShowFromHome()
    {
        ...
        SetColliders(true);
        ResumeAi();
        NpcRoleUtility.SetAction(gameObject, "Ra kh?i nhà");
    }
